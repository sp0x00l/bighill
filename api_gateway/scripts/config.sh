...
if [ "$ENVIRONMENT" = "local-dev" ] || [ "$ENVIRONMENT" = "cicd" ]; then
    ...
    export AGENT_REGISTRY_SERVICE_HTTP_HOST="$API_GATEWAY_SERVICE_HOST"
    export TOOL_CATALOG_SERVICE_HTTP_HOST="$API_GATEWAY_SERVICE_HOST"
    ...
    export AGENT_REGISTRY_SERVICE_HTTP_HOST=agent-registry-service
    export TOOL_CATALOG_SERVICE_HTTP_HOST=tool-catalog-service
fi
...
export AGENT_REGISTRY_SERVICE_HTTP_PORT=8090
export TOOL_CATALOG_SERVICE_HTTP_PORT=8091
