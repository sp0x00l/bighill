...
if [ "$1" = "local-dev" ] || [ "$1" = "cicd" ]; then
    ...
    export MODEL_SERVING_SERVICE_LOCAL_OLLAMA_ENDPOINT=
    export MODEL_SERVING_SERVICE_LOCAL_ARTIFACT_CACHE_DIR=
...
export MODEL_SERVING_SERVICE_BASE_RUNTIME_CRD_GROUP=serving.bighill.io
export MODEL_SERVING_SERVICE_BASE_RUNTIME_CRD_VERSION=v1alpha1
export MODEL_SERVING_SERVICE_BASE_RUNTIME_CRD_RESOURCE=baseruntimes
...
export MODEL_SERVING_SERVICE_VLLM_FORCE_DEDICATED_ADAPTERS=false
export MODEL_SERVING_SERVICE_VLLM_MAX_LORAS=8
export MODEL_SERVING_SERVICE_VLLM_MAX_LORA_RANK=16
