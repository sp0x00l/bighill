...
if [ "$1" = "local-dev" ] || [ "$1" = "cicd" ]; then
    ...
    export FEATURE_MATERIALIZER_EMBEDDING_PROVIDER=${FEATURE_MATERIALIZER_EMBEDDING_PROVIDER:-deterministic}
    export FEATURE_MATERIALIZER_EMBEDDING_URL=${FEATURE_MATERIALIZER_EMBEDDING_URL:-}
elif [ "$1" = "staging" ]; then
    export FEATURE_MATERIALIZER_SERVICE_DLQ=http://localhost:4566/feature-materializer-dev-env-queue/ # TODO
    export FEATURE_MATERIALIZER_DB_HOST=$PGHOST
    export FEATURE_MATERIALIZER_DB_PORT=$PGPORT
    export FEATURE_MATERIALIZER_DB_SSLMODE=$PGSSLMODE
    export FEATURE_MATERIALIZER_EMBEDDING_PROVIDER=${FEATURE_MATERIALIZER_EMBEDDING_PROVIDER:-tei}
    export FEATURE_MATERIALIZER_EMBEDDING_URL=${FEATURE_MATERIALIZER_EMBEDDING_URL:-http://tei-embeddings:8080}
elif [ "$1" = "prod" ]; then
...
export FEATURE_MATERIALIZER_API_GRPC_PORT=7072
...
export FEATURE_MATERIALIZER_EXTRACTOR_NAME=go-document-extractor-suite
export FEATURE_MATERIALIZER_EXTRACTOR_VERSION=v1
export FEATURE_MATERIALIZER_CLEANER_NAME=go-basic-text-cleaner
export FEATURE_MATERIALIZER_CLEANER_VERSION=v1
