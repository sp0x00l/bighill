...
if [ "$1" = "local-dev" ] || [ "$1" = "cicd" ]; then
    ...
    export FEATURE_MATERIALIZER_DB_PORT=$PGPORT
    export FEATURE_MATERIALIZER_DB_SSLMODE=$PGSSLMODE
    export FEATURE_MATERIALIZER_EMBEDDING_PROVIDER=${FEATURE_MATERIALIZER_EMBEDDING_PROVIDER:-ollama}
    export FEATURE_MATERIALIZER_EMBEDDING_URL=${FEATURE_MATERIALIZER_EMBEDDING_URL:-http://ollama:11434}
elif [ "$1" = "prod" ]; then
