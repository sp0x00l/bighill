...
install_python_tooling()
{
    ...
    pyenv exec python -m pip install --upgrade -e "$ROOT_DIR/shared_py"
...
echo "     External datasource fixtures are opt-in; run make start-data-sources or make test-api-data-sources when needed."
