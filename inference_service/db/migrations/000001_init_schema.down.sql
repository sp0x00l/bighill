...
DROP TABLE IF EXISTS bighill_inference_db.agent_run_labels;
...
DROP TABLE IF EXISTS bighill_inference_db.golden_tasks;
DROP TABLE IF EXISTS bighill_inference_db.agent_adapters;
DROP TABLE IF EXISTS bighill_inference_db.agent_champion_states;
DROP TABLE IF EXISTS bighill_inference_db.agent_specs;
DROP TABLE IF EXISTS bighill_inference_db.capability_reports;
DROP TABLE IF EXISTS bighill_inference_db.effective_base_versions;
...
DROP TYPE IF EXISTS agent_training_eligibility_enum;
DROP TYPE IF EXISTS agent_stop_reason_enum;
DROP TYPE IF EXISTS agent_run_status_enum;
DROP TYPE IF EXISTS golden_task_split_enum;
DROP TYPE IF EXISTS agent_endpoint_mode_enum;
DROP TYPE IF EXISTS agent_runtime_mode_enum;
DROP TYPE IF EXISTS agent_spec_status_enum;
DROP TYPE IF EXISTS agent_adapter_status_enum;
DROP TYPE IF EXISTS effective_base_status_enum;
DROP TYPE IF EXISTS agent_candidate_pipeline_state_enum;
DROP TYPE IF EXISTS agent_maturity_enum;
