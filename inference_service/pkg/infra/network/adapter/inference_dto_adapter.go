...
type InferenceDTOAdapter interface {
	...
	FromPreferenceDatasetBuildDTO(ctx context.Context, body []byte) (model.PreferenceDatasetBuildRequest, error)
	ToPreferenceDatasetDTO(ctx context.Context, dataset *model.PreferenceDataset) ([]byte, error)
	ToPreferenceDatasetDTOs(ctx context.Context, datasets []*model.PreferenceDataset) ([]byte, error)
...
func (a *inferenceDTOAdapter) FromPreferenceDatasetBuildDTO(ctx context.Context, body []byte) (model.PreferenceDatasetBuildRequest, error) {
	log.Trace("InferenceDTOAdapter FromPreferenceDatasetBuildDTO")
...
func (a *inferenceDTOAdapter) ToPreferenceDatasetDTO(ctx context.Context, dataset *model.PreferenceDataset) ([]byte, error) {
	log.Trace("InferenceDTOAdapter ToPreferenceDatasetDTO")
...
func (a *inferenceDTOAdapter) ToPreferenceDatasetDTOs(ctx context.Context, datasets []*model.PreferenceDataset) ([]byte, error) {
	log.Trace("InferenceDTOAdapter ToPreferenceDatasetDTOs")
