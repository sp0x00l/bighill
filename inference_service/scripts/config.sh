...
export INFERENCE_GENERATION_PROVIDER=deterministic
export INFERENCE_GENERATION_ENDPOINT=http://localhost:11434
export INFERENCE_GENERATION_MODEL=llama3.1:8b
export INFERENCE_GENERATION_REQUEST_TIMEOUT_SECONDS=60
export INFERENCE_RERANKER_PROVIDER=disabled
export INFERENCE_RERANKER_URL=
export INFERENCE_RERANKER_MODEL=
export INFERENCE_RERANKER_REQUEST_TIMEOUT_SECONDS=30
export INFERENCE_RERANKER_CANDIDATE_MULTIPLIER=5
export INFERENCE_PREFERENCE_DATASET_EXPORT_ENABLED=false
export INFERENCE_PREFERENCE_DATASET_URI_TEMPLATE=s3://local-dev-bucket/preferences/{dataset_id}/preference_dataset.jsonl
export INFERENCE_PREFERENCE_DATASET_MIN_EXAMPLES=1
export INFERENCE_PREFERENCE_DATASET_LIMIT=1000
export INFERENCE_PREFERENCE_DATASET_BUCKET_REGION=local-dev
export INFERENCE_PREFERENCE_DATASET_UPLOAD_PART_SIZE_MB=10
export INFERENCE_PROMPT_STRATEGY_VERSION=rag-prompt-v1
export INFERENCE_PROMPT_MAX_CONTEXT_TOKENS=3000
export INFERENCE_PROMPT_MAX_CONTEXT_CHUNKS=8
