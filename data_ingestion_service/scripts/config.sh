...
if [ "$1" = "local-dev" ] || [ "$1" = "cicd" ]; then
    export DATA_INGESTION_SERVICE_FILES_BUCKET_REGION=local-dev
    export DATA_INGESTION_SERVICE_FILES_BUCKET_NAME=local-dev-bucket
    ...
    export DATA_INGESTION_SERVICE_FILES_BUCKET_REGION=${AWS_DEFAULT_REGION}
    export DATA_INGESTION_SERVICE_FILES_BUCKET_NAME=adt-datalake-rawdata-prod-255525589248-eu-west-1 # TODO
    ...
    export DATA_INGESTION_SERVICE_FILES_BUCKET_REGION=${AWS_DEFAULT_REGION}
    export DATA_INGESTION_SERVICE_FILES_BUCKET_NAME=adt-datalake-rawdata-prod-255525589248-eu-west-1
...
export DATA_INGESTION_SERVICE_FILE_MAX_SIZE_MB=2000
export DATA_INGESTION_SERVICE_FILES_UPLOAD_PART_SIZE_MS=${AWS_DEFAULT_UPLOAD_PART_SIZE_MB:-10}
export DATA_INGESTION_SERVICE_DB_NAME=bighill_data_ingestion_db
export DATA_INGESTION_SERVICE_DB_USER=bighill_data_ingestion_db_user
export DATA_INGESTION_SERVICE_DB_PASSWORD=$BIGHILL_DB_PASSWORD
export DATA_INGESTION_SERVICE_DB_MAX_CONNECTIONS=20
export DATA_INGESTION_SERVICE_API_HTTP_PORT=8086
...
export DATA_INGESTION_SERVICE_HEALTHCHECK_CPU_THRESHOLD_PERCENT=80
export DATA_INGESTION_SERVICE_HEALTHCHECK_FREE_MEM_THRESHOLD_PERCENT=20
export DATA_INGESTION_SERVICE_HEALTHCHECK_PORT=5056
export DATA_INGESTION_SERVICE_HEALTHCHECK_SERVICE_LATENCY_THRESHOLD_SECONDS=5
export DATA_INGESTION_SERVICE_HEALTHCHECK_DB_LATENCY_THRESHOLD_SECONDS=5
export DATA_INGESTION_SERVICE_HEALTHCHECK_MSG_BROKER_LATENCY_THRESHOLD_SECONDS=5
